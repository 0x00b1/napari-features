...
FEATURES = {
    ...
    "Texture": {
        "Object": {
            ...
            "Haralick, contrast",
            "Haralick, coorelation",
            "Haralick, difference variance",
            "Haralick, entropy",
            "Haralick, inverse difference moment",
            "Haralick, maximum correlation coefficient"
            "Haralick, measure of correlation",
            "Haralick, sum average",
            "Haralick, sum entropy",
            "Haralick, sum of squares_variance",
    ...
    def __init__(
        ...
        for descriptor in FEATURES.keys():
            ...
            for name in FEATURES[descriptor]:
                ...
                for feature in FEATURES[descriptor][name]:
